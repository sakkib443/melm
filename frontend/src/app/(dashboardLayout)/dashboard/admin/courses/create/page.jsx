    ...
    return (
        <div className="p-6 lg:p-8">
            ...
            <div className="flex items-center gap-4 mb-8">
                <Link href="/dashboard/admin/courses" className="btn btn-ghost p-3">
                    <FiArrowLeft size={20} />
                </Link>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Add a new course to the LMS</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex gap-4 mt-6">
                    <Link href="/dashboard/admin/courses" className="btn btn-ghost flex-1">Cancel</Link>
