            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">Add a new lesson to a module</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="card p-6 space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                {formData.course && modules.length === 0 && (
                                    <p className="text-xs text-amber-600 mt-1">
                                        No modules found. <Link href="/dashboard/admin/modules/create" className="underline">Create one first</Link>
                                    </p>
                                )}
                            </div>
                        </div>
